...
export function D(v) {
    if (v instanceof Decimal)
        return v;
    if (typeof v === "number")
        return new Decimal(v.toString()); // via string to avoid FP
...
export function normalizePrice(d) {
